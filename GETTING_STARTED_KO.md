...
- 선택적 실내 범위: [INTERIOR_SCOPE_KO.md](INTERIOR_SCOPE_KO.md)
- V1.0까지의 공식 단계: [ROADMAP_V1_KO.md](ROADMAP_V1_KO.md)

실내는 기본 비활성화입니다. 건물 내부가 필요한 경우에만 draft → exact-hash approval → validation 절차를 수행합니다. Unity, Unreal 또는 다른 목적 엔진 adapter는 실제 환경 검증 전까지 지원된 것으로 취급하지 않습니다.
