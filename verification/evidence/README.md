...
- `aq_v1_20260810/`: AQ 0.1 최종 benchmark, 성공 terminal의 package·roundtrip·handoff
  직접 종속물, 비통과 terminal의 review bundle snapshot.
- `aq_v2_20260811/`: AQ 0.2 최종 benchmark와 두 Blender benchmark fixture receipt.
- `v07_20260811/`: GLB·FBX·OBJ package manifest와 clean-import roundtrip snapshot.
- `v08_20260811/`: standard/background workflow state, QA, FBX package·roundtrip snapshot.
- `v09_20260811/`: production/desktop/queue state와 portable handoff·roundtrip snapshot.
